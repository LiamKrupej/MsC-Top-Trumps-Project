...
public class TopTrumpsRESTAPI {
	...
	public ArrayList<Integer> getOverallStats() throws IOException {
		...
		overalldata.add(controller.getAIwins());
	...
	public ArrayList<Integer> getLastGameStats() throws IOException {
		
		ArrayList<Integer> lastgamedata = null;
		
		// last game data
		
		lastgamedata.add(controller.getRoundsInGame());
		lastgamedata.add(controller.getGameWinner());
		lastgamedata.add(model.getNumOfDraws());
		lastgamedata.add(controller.getRoundsPerPlayer());
