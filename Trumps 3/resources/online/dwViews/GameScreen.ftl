  ...
  <body onload="initalize()"
    <div class="container">
      <div class="card-deck">
          <div class="card">
              <div class="card-body">
                  ...
                  <div class="list-group">
                      ...
                      <button type="button" onclick="KeyboardDur();"class="list-group-item3 list-group-item-action">Duration:<span id="p1Duration"></button>
          ...
          <button class="btn" onclick="getAttributes() + player2() + player3()  + player4() + player5(); this.disabled=true;">Play<span id="Play"></span></button>
          <button class="btn2" >Next Round<span id="Round" ></span></button>
        ...
        <script type="text/javascript">
            ...
            function KeyboardSize() {
              ...
              xhr.onload = function(e) {
                 ...
                 $("#Winner").text("Player " + response6 + " fuckin won it");
            ...
            function KeyboardPop() {
                ...
                xhr.onload = function(e) {
                    ...
                    $('.list-group-item2').prop('disabled', true);
                    $("#Winner").text("Player " + response7 + " fuckin won it");
                    $('.list-group-item2').show();
                    $('.card-title1').show();
             ...
             function KeyboardAnt() {
                 ...
                 xhr.onload = function(e) {
                     ...
                     $('.list-group-item3').prop('disabled', true);
                     $('.list-group-item2').prop('disabled', true);
                     $("#Winner").text("Player " + response8 + " fuckin won it");
                     $('.list-group-item2').show();
                     $('.card-title1').show();
             ...
             function KeyboardDuration() {
                ...
                xhr.onload = function(e) {
                   ...
                   $('.list-group-item3').prop('disabled', true);
                   $('.list-group-item2').prop('disabled', true);
                   $("#Winner").text("Player " + response9 + " fuckin won it");
                   $('.list-group-item2').show();
                   $('.card-title1').show();
             ...
             function KeyboardCool() {
                ...
                xhr.onload = function(e) {
                     ...
                     $('.list-group-item3').prop('disabled', true);
                     $('.list-group-item2').prop('disabled', true);
                     $("#Winner").text("Player " + response10 + " fuckin won it");
                     $('.list-group-item2').show();
                     $('.card-title1').show();
                };
